...
c
      ...
      parameter (nco_temp   = 11)
      parameter (nco_column = 10)
      parameter (nco_data   = 110)
c
...
c
      DATA co_temp /10., 20., 30., 50., 80., 100., 300., 600., 1000.,
     $              1500., 2000./
     ...
     $                 23.40, 23.07, 22.81, 22.61, 22.47/
      ...
      DATA co_data_LTE / 21.15, 20.39, 19.97, 19.47, 19.02, 18.81, 
     $                   17.82, 17.23, 16.82, 16.52, 16.33,
     $                   21.25, 20.45, 20.02, 19.50, 19.04, 18.83, 
     $                   17.83, 17.24, 16.82, 16.52, 16.33,
     $                   21.45, 20.58, 20.12, 19.57, 19.09, 18.87, 
     $                   17.84, 17.24, 16.83, 16.52, 16.33,
     $                   21.73, 20.81, 20.31, 19.71, 19.20, 18.96, 
     $                   17.88, 17.26, 16.84, 16.53, 16.33,
     $                   22.08, 21.11, 20.58, 19.95, 19.39, 19.14, 
     $                   17.98, 17.32, 16.88, 16.56, 16.35,
     $                   22.47, 21.46, 20.91, 20.25, 19.67, 19.40, 
     $                   18.15, 17.44, 16.96, 16.62, 16.40,
     $                   22.89, 21.85, 21.28, 20.60, 19.99, 19.71, 
     $                   18.41, 17.65, 17.13, 16.76, 16.52,
     $                   23.32, 22.25, 21.67, 20.97, 20.35, 20.07, 
     $                   18.72, 17.93, 17.38, 16.98, 16.72,
     $                   23.76, 22.68, 22.08, 21.37, 20.74, 20.45, 
     $                   19.07, 18.26, 17.69, 17.27, 17.00,
     $                   24.21, 23.11, 22.51, 21.78, 21.14, 20.85, 
     $                   19.45, 18.62, 18.03, 17.61, 17.33/

      DATA co_data_n05 / 3.31, 3.72, 3.96, 4.24, 4.39, 4.42,
     $                   4.95, 5.24, 5.43, 5.57, 5.68,
     $                   3.11, 3.59, 3.87, 4.17, 4.35, 4.38,
     $                   4.93, 5.23, 5.42, 5.57, 5.68,
     $                   2.80, 3.34, 3.64, 4.01, 4.23, 4.24,
     $                   4.88, 5.20, 5.42, 5.56, 5.68,
     $                   2.37, 2.95, 3.31, 3.73, 3.99, 4.01,
     $                   4.75, 5.13, 5.36, 5.54, 5.65,
     $                   1.90, 2.50, 2.87, 3.33, 3.61, 3.64,
     $                   4.50, 4.95, 5.24, 5.44, 5.58,
     $                   1.40, 2.02, 2.40, 2.86, 3.17, 3.21,
     $                   4.12, 4.65, 5.00, 5.25, 5.41,
     $                   0.90, 1.52, 1.90, 2.38, 2.69, 2.72,
     $                   3.67, 4.25, 4.63, 4.92, 5.13,
     $                   0.40, 1.02, 1.41, 1.89, 2.19, 2.22,
     $                   3.20, 3.77, 4.18, 4.51, 4.73,
     $                   -0.09, 0.52, 0.91, 1.39, 1.69, 1.73,
     $                   2.69, 3.29, 3.70, 4.03, 4.26,
     $                   -0.59, 0.03, 0.41, 0.88, 1.19, 1.23,
     $                   2.20, 2.79, 3.20, 3.54, 3.78/

      DATA co_data_alp / 0.37, 0.41, 0.42, 0.41, 0.38, 0.38, 
     $                   0.38, 0.38, 0.37, 0.36, 0.35,
     $                   0.38, 0.42, 0.44, 0.42, 0.39, 0.37, 
     $                   0.37, 0.37, 0.37, 0.36, 0.35,
     $                   0.38, 0.43, 0.44, 0.43, 0.40, 0.36, 
     $                   0.36, 0.36, 0.36, 0.35, 0.34,
     $                   0.36, 0.41, 0.43, 0.43, 0.40, 0.36, 
     $                   0.35, 0.35, 0.35, 0.34, 0.33,
     $                   0.34, 0.37, 0.39, 0.39, 0.39, 0.38, 
     $                   0.35, 0.34, 0.34, 0.33, 0.32,
     $                   0.31, 0.33, 0.35, 0.35, 0.35, 0.41, 
     $                   0.37, 0.35, 0.33, 0.32, 0.31,
     $                   0.28, 0.31, 0.32, 0.32, 0.31, 0.44, 
     $                   0.40, 0.37, 0.35, 0.32, 0.31,
     $                   0.26, 0.28, 0.29, 0.28, 0.28, 0.47, 
     $                   0.43, 0.40, 0.38, 0.35, 0.33,
     $                   0.25, 0.26, 0.26, 0.26, 0.26, 0.49, 
     $                   0.46, 0.43, 0.41, 0.38, 0.36,
     $                   0.23, 0.25, 0.25, 0.24, 0.25, 0.51, 
